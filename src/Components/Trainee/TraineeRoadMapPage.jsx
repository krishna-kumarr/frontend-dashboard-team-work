...
import "./TraineeCss/TraineeRoadMap.css"
import { MdLockOutline } from "react-icons/md";

export const TraineeRoadMapPage = () =>{
    useEffect(()=>{
        Aos.init()
    },[])
    const timeLineArray =[
                                                ...
                                                <div className="col-11 roadmap-box">
                                                    {
                                                        val.TimeLineCharts.map((value,index)=>{
                                                            return   <div className="roadmap-content trainee-roadmap-card shadow text-start mb-3 ms-5 timeline-content d-flex flex-wrap align-items-center" key={index}>
                                                                        {
                                                                        ...
                                                                        <div className="trainee-roadmap-lock col-12">
                                                                            <div className="fs-1 col"><MdLockOutline/></div>                                                                         
                                                                        </div>
                                                                    </div>
                                                        })
                                                    }
