...
export const TraineeDashboardHeader = () =>{
    ...
    return(
        <>
            ...
            <nav class="header header-default-background" id="header">
                ...
                <ul className="d-inline-flex col-10 col-sm-7 col-md-5 col-lg-4 col-xl-2 m-0 align-items-center justify-content-center header-ul">
                    <li>
                        {
                            defaultTheme ? 
