...
export const SuperAdminSecurityPracticesPage = () =>{
    useEffect(()=>{
        Aos.init()
    },[])
                        ...
                        <div className="d-flex flex-wrap justify-content-center">
                            <div className="col-11 d-flex flex-wrap align-items-center">
                                ...
                                <div className="col-4 col-md-2 text-end">
                                    <button type="button" className="btn add-securityPractices-btn border-0 text-light" data-bs-toggle="modal" data-bs-target="#staticBackdropAddSecurityPractices">Add</button>
                                </div>
                            </div>
                                        ...
                                        <div className="col-12 col-lg-8 p-4">
                                            ...
                                            <div className="col-12 d-flex justify-content-end">
                                                <div className="col-4 col-md-5 col-lg-3 text-center read-more-btn"  data-bs-toggle="modal" data-bs-target="#staticBackdropReadMore" >
                                                    <button type="button" className="btn m-0 rounded text-light" onClick={()=>handleSecurityPracticeModel(v)}>Read more</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="modal-content security-practice-modal-content">
                                ...
                                <form className="modal-body text-dark">
                                    ...
                                    <div className="text-end">
                                        ...
                                        <button type="button" class="btn add-securityPractices-btn text-light"data-bs-dismiss={addMoreSecurity.title!=="" && addMoreSecurity.therory!=="" ? "modal" : null} aria-label={addMoreSecurity.title!=="" && addMoreSecurity.therory!=="" ? "Close" : null} onClick={handleSubmitSecurityPractices}>save</button>
                                    </div>
                                </form>  
                            </div>
                        </div>
                                ...
                                <div className="modal-body">
                                    {
                                        modelboxContent.image!==undefined ? 
                                            <div className="col-12 p-1 security-attack-image-modelBox text-center py-3">
                                                <img src={require('../image/'+modelboxContent.image)} alt="security-attack-image"/>
                                            </div>
                                        :
                                            null
                                    }
